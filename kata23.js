...
describe('Class accessors (getter and setter)', () => {
  it('a getter is defined like a method prefixed with `get`', () => {
    class MyAccount {
      get balance() { return Infinity; }// changed money to balance
    }
  ...
  it('a setter has the prefix `set`', () => {
    class MyAccount {
      ...
      set balance(amount) { this.amount = 23; }//changed default amount to 23
    }
  ...
  describe('dynamic accessors', () => {
    it('a dynamic getter name is enclosed in `[]`', function() {
      ...
      class YourAccount {
        get [balance]() { return -Infinity; }// changed 'getter' to 'balance' its a variable
      }
