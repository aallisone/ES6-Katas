...
describe('`Map` is a key/value map', function(){
  ...
  it('complex types can be keys', function() {
    ...
    let map = new Map();
    map.set(obj, '');
    assert.equal(map.has(otherObj), false);//removed other map.has()
  });
});
